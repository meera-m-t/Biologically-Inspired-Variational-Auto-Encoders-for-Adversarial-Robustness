...
from attackers import FGSM, BIM, DeepFool, PGD
...
attacker=PGD(num_steps=40, step_size=0.01,eps=0.3, eps_norm='inf',step_norm='inf',clip_max=CLIP_MAX, clip_min=CLIP_MIN, y_target=None)
print('attacker: {}'.format(type(attacker).__name__))

demo_idxs = [445, 107, 98, 172, 67, 65, 51, 771, 457, 200]
