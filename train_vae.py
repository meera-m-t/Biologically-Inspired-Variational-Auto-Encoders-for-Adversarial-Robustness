...
### read adv and true
savedir = base_savedir + 'AdvSave/multiattack/model_{}/multi_{}/'.format(args.multi)
...
savedir = base_savedir + 'vae_model_lambda/init_multi/vaeModel_{}/epochs_{}/lr_{}/batchSize_{}' \
                         '/multi_{}/rBegin_{}/rEnd_{}/sigmoid_{}/siglambda_{}/init1_{}/int2_{}/init3_{}/int4_{}/'.format(
    args.vae_model, args.epochs, args.lr, args.batch_size, args.multi, args.r_begin, args.r_end,
...
torch.save(model.state_dict(), savedir + 'VAE_model.pth')
